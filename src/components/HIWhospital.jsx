...
import point1 from '../Assets/Images/HIW/Hospitals icons/Point-1 Icon.svg';
import point2 from '../Assets/Images/HIW/Hospitals icons/Point-2 Icon.svg';
import point3 from '../Assets/Images/HIW/Hospitals icons/Point-3 Icon.svg';
import point4 from '../Assets/Images/HIW/Hospitals icons/Point-4 Icon.svg';
			...
			<div className=" flex flex-col lg:flex-row md:ml-36 md:mr-36 mx-auto">
				...
				<div className=' lg:mt-0   m-auto '>
					...
					<div className='flex '>
							...
							<h2 className="text-gray-primary font-medium ">Select a hospital by specialty or by name</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-8 md:h-7" src={point2} alt="point1" />
							</div>
							<h2 className="text-gray-primary font-medium ">Click on the 'Enquire' button and fill in Hospital Enquiry Form</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-8 md:h-7" src={point3} alt="point1" />
							</div>
							<h2 className="text-gray-primary font-medium ">CureBay support team will reach out to understand details of your requirements</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-8 md:h-7 w-20" src={point4} alt="point1" />
							</div>
							<h2 className="text-gray-primary font-medium ">CureBay suppor team will find out the best possible options for you and after discussion with you ,arrange for treatment at best possible hospital</h2>
						</div>
					</div>
