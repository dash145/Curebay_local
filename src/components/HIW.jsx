...
import point1 from '../Assets/Images/HIW/Homepage/Point-1.svg';
import point2 from '../Assets/Images/HIW/Homepage/Point-2.svg';
import point3 from '../Assets/Images/HIW/Homepage/Point-3.svg';
import point4 from '../Assets/Images/HIW/Homepage/Point-4.svg';
import point5 from '../Assets/Images/HIW/Homepage/Point-5.svg';
import point6 from '../Assets/Images/HIW/Homepage/Point-6.svg';
		...
		<>
			<div className=" flex flex-col lg:flex-row md:ml-36 md:mr-36 mx-auto">
				...
				<div className=' lg:mt-0   m-auto '>
					...
					<div className='grid grid-cols-1 lg:grid-cols-2 w-11/12 md:w-full  mx-auto  justify-between gap-6 xl:gap-10 '>
						<div className='flex gap-2 md:gap-0'>
							...
							<h2 className="text-gray-primary font-medium " >Select a doctor by speciality or by symptoms for video consultation</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
							...
							<h2 className="text-gray-primary font-medium ">We will make all your medical records digitally available</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-3 md:mr-4">
								<img className="h-7 md:h-7" src={point3} alt="point1" />
							</div>

							<h2 className="text-gray-primary font-medium ">Get branded medicines at discount</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-8 md:h-7" src={point4} alt="point1" />
							</div>

							<h2 className="text-gray-primary font-medium ">You pay the lowest price for branded medicines</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-8 md:h-7" src={point5} alt="point1" />
							</div>

							<h2 className="text-gray-primary font-medium ">Talk to us to find out the best possible hospital care at the best price</h2>
						</div>
						<div className='flex gap-2 md:gap-0'>
							<div className="mr-4">
								<img className="h-10 w-14 md:h-10 md:w-auto" src={point6} alt="point1" />
							</div>

							<h2 className="text-gray-primary font-medium ">Get your medicines delivered at home, lab samples collected at home and doctor consultation from comfort of your home</h2>
						</div>
					</div>
