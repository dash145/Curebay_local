...
function WellnessForever() {
	...
	return (
        ...
        <div className="flex flex-col bg-white m-auto p-auto">
				<p className="text-xl font-medium text-gray-700 ml-10">Showing products from “Wellness Forever Pharmacy” </p>
				<div className="flex justify-between ml-10">
					<p className="text-sm text-gray-400">Showing 12 of 112 items</p>
...
export default connect(null, mapDispatchToProps,)(WellnessForever);
