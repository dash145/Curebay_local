    ...
    return (
      ...
      <div className="w-6/12 shadow-lg bg-white-600  h-112 p-5 antialiased justify-between border border-gray-500">
                    <div className="pl-2 pr-5  flex items-center justify-between">
                        <p className="inline px-2 rounded-full text-md  font-medium cursor-pointer text-brand-secondary">Add Medicine Prescriptions</p>
                    ...
                    <div> <p className="pl-12 pb-5 text-sm text-gray-500 font-medium">Medicine Prescription</p>
                                    <div className="flex space-x-12 pt-4 pl-12">
                                       
                                        <div className="relative">
                                        <div className="relative">
                                            <div className="flex">
                                            <lable className="py-2 w-80 text-xs text-gray-400 border-b-2 border-gray-300">Vijay Sharma</lable>
                                            </div>
