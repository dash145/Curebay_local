...
function Patientprofileoxygencard(props) {
                ...
                <>
                    ...
                    <div class="w-4/8 p-4 border border-gray-200 rounded-xl justify-between ">
                        ...
                        <div class="flex justify-between mb-2">
                            <p class="text-sm font-semibold text-neutral-800">Pulse Ox.</p>
...
{/* 
                        ...
                        <div className='flex justify-center items-center' style ={{backgroundColor:"#FFFCEE", border: "1px solid #F4ECC8", borderRadius:"50%",height:"69px",width:"69px"}}>
                            ...
                            <div className='text-center'>
                                <p className='font-semibold text-xs mb-2'>SpO2</p>
                                <p  className='font-normal text-xs'>Latest</p>
                                <p className='font-semibold text-xl'>{user.spo2}%</p>
                            </div>
                        </div>

                        {
                            showviewall ? <Allvitalspopup data={data} title={'Oxygen'} closePopup={() => setshowviewall(!showviewall)}></Allvitalspopup> : null
                        }

                        {
                            showentervitals ? <Addvitalspopup data={props.data[0]} title={'Oxygen'} closePopup={saveSuccess}></Addvitalspopup> : null

                        }


                        {
                            showremovevitals ? <Removevitalspopup title={'Oxygen'} closePopup={() => setshowremovevitals(!showremovevitals)}></Removevitalspopup> : null

                        }

                        {
                            graphPop ? <VitalChart title = {'Pulse Ox. Graph'} data={props.data} type="spo2" closePopup={()=> setGraphPop(false)} /> : null
                        }
...
export default Patientprofileoxygencard;