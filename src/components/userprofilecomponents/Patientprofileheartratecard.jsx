...
import heartIcon from "../../Assets/Images/heartRate.png"

function Patientprofileheartratecard(props) {
                ...
                <>
                    ...
                    <div class="w-4/8 p-4 border border-gray-200 rounded-xl justify-between">
                        ...
                        <div class="flex justify-between mb-2">
                            ...
                            <p class="text-sm font-semibold text-neutral-800">Heart Rate</p>
                            <div class="flex justify-end space-x-2">
                                <div className="cursor-pointer" onClick={()=>setGraphPop(true)}>
                        ...
                        <div className='flex justify-center items-center' style ={{backgroundColor:"#FFFCEE", border: "1px solid #F4ECC8", borderRadius:"50%",height:"69px",width:"69px"}}>
                                <img height="40px"  width="40px" src ={heartIcon} />
                            </div>
                            <div className='text-center'>
                                <p className='font-semibold text-xs mb-2'>Beats</p>
                                <p className='font-normal text-xs'>Latest</p>
                                <p className='font-semibold text-xl'>{user.heartRate}</p>
                                <p className='font-normal text-xs'>beats/min </p>
                            </div>
                        </div>

                        {
                            showviewall ? <Allvitalspopup data={data} title={'Heart Rate'} closePopup={() => setshowviewall(!showviewall)}></Allvitalspopup> : null
                        }

                        {
                            showentervitals ? <Addvitalspopup data={props.data[0]} title={'Heart Rate'} closePopup={saveSuccess}></Addvitalspopup> : null

                        }


                        {
                            showremovevitals ? <Removevitalspopup title={'Heart Rate'} closePopup={() => setshowremovevitals(!showremovevitals)}></Removevitalspopup> : null

                        }


                        {
                            graphPop ? <VitalChart title = {'Heart Rate Graph'} data={props.data} type="heartRate" closePopup={()=> setGraphPop(false)} /> : null
                        }
...
export default Patientprofileheartratecard;