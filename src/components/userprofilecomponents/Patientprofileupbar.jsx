...
import { getparticularPatientdetailsbynumber } from "../../Redux/Actions/patientAction";
...
function Patientprofileupbar(props) {
  ...
  useEffect(() => {
    ...
    console.log("numberrrrrrrrrrrrr", loggincheadminData);
  }, [dispatch]);
  return (
    <>
      <div class="overflow-hidden px-10 py-4">
        <div class="flex justify-between">
          {loggincheadminData.slice(0, 1).map((user, i) => (
            <div class="flex space-x-3" key={i}>
