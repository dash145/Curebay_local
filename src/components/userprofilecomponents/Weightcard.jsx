                ...
                <>
                    ...
                    <div class="w-4/8 p-4 border border-gray-200 rounded-xl justify-between ">
                        ...
                        <div class="flex justify-between mb-2">
                            <p class="text-sm font-semibold text-neutral-800">Weight</p>
                        ...
                        <div className='flex justify-center items-center' style ={{backgroundColor:"#FFFCEE", border: "1px solid #F4ECC8", borderRadius:"50%",height:"69px",width:"69px"}}>
                                <img height="40px"  width="40px" src ={Weight} />
                            </div>
                            <div className='text-center'>
                                <p className='font-semibold text-xs mb-2'>Kilogram</p>
                                <p className='font-normal text-xs'>Latest</p>
                                <p className='font-semibold text-xl'>{user.weight}kg</p>
                            </div>
                        </div>

                        {
                            showviewall ? <Allvitalspopup data={data} title={'Weight'} closePopup={() => setshowviewall(!showviewall)}></Allvitalspopup> : null
                        }

                        {
                            showentervitals ? <Addvitalspopup data={props.data[0]} title={'Weight'} closePopup={() => saveSuccess()}></Addvitalspopup> : null

                        }


                        {
                            showremovevitals ? <Removevitalspopup title={'Weight'} closePopup={() => setshowremovevitals(!showremovevitals)}></Removevitalspopup> : null
