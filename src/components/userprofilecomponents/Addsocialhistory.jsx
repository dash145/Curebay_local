...
import { patientaddsocialhistory, getsocialhistory, getPatientfamilymembers as getpatientfamilymemberslist } from "../../Redux/Actions/UserprofileActions";
...
function Addsocialhistory(props) {
    ...
    const savemedicalhistorys = (e) => {
        if (!addsocialhistory.description) {
            ...
            if (FamilymemberName == "" || FamilymemberName == undefined) {
                ...
                dispatch(patientaddsocialhistory(data)).then((result) => {
                    dispatch(getsocialhistory(props.patient ? props.patient : patientCode));
                    props.closePopup()
                })
            } else {
                // let patient = localStorage.getItem("patientprofile")
                                    ...
                                    <div className="relative">
                                        <div className="relative mb-4">
                                            <DatePicker
                                                ...
                                                className={
                                                    "border-b-2 border-gray-300 pt-2 text-gray-900 bg-transparent focus:outline-none text-xs"
                                                }
                                            />
                                            <label
                                                htmlFor="recordOn"
                                    ...
                                    <div className="relative w-full">
                                        <div className="flex w-11/12">
                                            <textarea
                                                ...
                                                className="peer w-full text-xs h-50  border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
