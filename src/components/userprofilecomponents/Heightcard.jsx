...
import oxy from "../../Assets/Images/height.png";
...
import Height from "../../Assets/Images/heightIcon.png"
  ...
  return (
    <>
      {props?.data?.slice(0, 1).map((user, i) => (
        <>
          <div class="w-4/8 p-4 border border-gray-200 rounded-xl justify-between mb-2">
            ...
            <div className='flex justify-center items-center' style ={{backgroundColor:"#FFFCEE", border: "1px solid #F4ECC8", borderRadius:"50%",height:"69px",width:"69px"}}>
                                <img height="40px"  width="40px" src ={Height} />
                            </div>
                            <div className='text-center'>
                                <p className='font-semibold text-xs mb-2'>Centimetre</p>
                                <p className='font-normal text-xs'>Latest</p>
                                <p className='font-semibold text-xl'>{user.height}cm</p>
                            </div>
                        </div>
            ...
            {showremovevitals ? (
              <Removevitalspopup
                title={"Height"}
                closePopup={() => setshowremovevitals(!showremovevitals)}
              ></Removevitalspopup>
            ) : null}
