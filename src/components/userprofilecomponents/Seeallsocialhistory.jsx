...
function Seeallsocialhistory() {
  ...
  const getMedicalHistoryFunc = () => {
    dispatch(getsocialhistory(patientCode));
  };
  ...
  const filterData = (fromDate, toDate) => {
    ...
    if (fromDate && toDate) {
      dispatch(getfilteredsocialhistory(isPatientCode, fromDate, toDate));
    } else {
      dispatch(getsocialhistory(isPatientCode));
    }
    setshowfilter(false);
  };
            ...
            <div className="-my-2 lg:-mx-8">
              ...
              <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 bg-white mt-4 border border-gray-200">
                ...
                <div className="shadow mx-2 overflow-hidden border-b border-gray-200 sm:rounded-lg ">
                  ...
                  <div className="h-80 w-full overflow-x-scroll overflow-y-scroll">
                      ...
                      <tbody className=" md:divide-y divide-gray-200">
                        {socialhistoryDataList.map((user, i) => (
                          <tr className="border-b border-gray-200" key={i}>
                            <td
                              data-label="Patientname"
                              className="px-1 md:px-6 py-2 whitespace-nowrap"
                            >
                              <div className="flex items-center">
                                <div className=" flex md:space-x-2">
                                  <input
                                    type="radio"
                                    class="hidden md:block form-radio mt-1 mr-2"
                                    name="accountType"
                                    value="personal"
                                  />
                            ...
                            <td
                              ...
                              className="px-2 md:px-6 py-2 whitespace-nowrap"
                            >
                            ...
                            <td
                              ...
                              className="px-1 md:px-6 py-2 whitespace-nowrap"
                            >
                              <span className="text-sm ml-2 md:ml-0 text-gray-500 ">
...
export default Seeallsocialhistory;
