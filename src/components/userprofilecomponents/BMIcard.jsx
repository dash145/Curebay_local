                ...
                <>
                    ...
                    <div class="w-4/8 p-4 border border-gray-200 rounded-xl justify-between ">
                        ...
                        <div class="flex justify-between mb-2">
                            <p class="text-sm font-semibold text-neutral-800">BMI</p>
                        ...
                        <div className='flex justify-around mt-4'>
                            <div className='flex justify-center items-center' style ={{backgroundColor:"#FFFCEE", border: "1px solid #F4ECC8", borderRadius:"50%",height:"69px",width:"69px"}}>
                                <img height="40px"  width="40px" src ={Bmi} />
                            </div>
                            <div className='text-center'>
                                <p className='font-semibold text-xs mb-2'>Index</p>
                                <p className='font-normal text-xs'>Latest</p>
                                <p className='font-semibold text-xl'>{user.bmi}</p>
                            </div>
                        </div>

                        {
                            showviewall ? <Allvitalspopup data={data} title={'Bmi'} closePopup={() => setshowviewall(!showviewall)}></Allvitalspopup> : null
                        }

                        {
                            showentervitals ? <Addvitalspopup data={props.data[0]} title={'Bmi'} closePopup={saveSuccess}></Addvitalspopup> : null

                        }


                        {
                            showremovevitals ? <Removevitalspopup title={'Bmi'} closePopup={() => setshowremovevitals(!showremovevitals)}></Removevitalspopup> : null
