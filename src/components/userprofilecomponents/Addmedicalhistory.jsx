...
import { getmedicalhistory } from "../../Redux/Actions/UserprofileActions";
...
function Addmedicalhistory(props) {
  ...
  const savemedicalhistorys = (e) => {
    if (!addmedicalhistory.description) {
      // toast("Enter Information")
    } else {
      if (props?.editmedicalhistory) {
        let patient = localStorage.getItem("patientprofile");
        ...
        const data = {
          ...
          // "recordFor": addmedicalhistory.recordFor,
          description: addmedicalhistory.description,
        ...
        dispatch(patientaddmedicalhistory(data)).then((result) => {
          dispatch(
            getmedicalhistory(props.patient ? props.patient : patientCode)
          );
          props.closePopup();
        });
      }
    ...
    <>
      ...
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-9/12 md:w-96 my-6 mx-auto max-w-3xl">
          {/*content*/}
          <div className="border-0 hiddenrounded-lg shadow-lg relative flex flex-col w-full p-5 bg-white outline-none focus:outline-none">
            {/*body*/}
                    ...
                    <div className="relative mb-4">
                      <DatePicker
                       ...
                       // className="pt-2 text-gray-900 "
                        ...
                        value={
                          addmedicalhistory.givenDate
                            ? moment(addmedicalhistory.givenDate).format(
                                "DD/MM/yyyy"
                              )
                            : ""
                        }
