...
useEffect(()=>{
    ...
    console.log('edml',index)
    console.log('edml',isOpen)
    ...
    const redirectTo = (e, location, val) => {
     e.preventDefault();
        let d = {
    ...
    const redirectToSub = (e, location, val) => {

        console.log('location haial',JSON.stringify(isOpen))
        e.preventDefault();
           let d = {
               isOpen: val ? val : false,
               index: val ? index : 0
    ...
    const [sideBardata, setSideBardata] = React.useState([
        ...
        {
            text: 'About CureBay',
            expand: index==6?MinusIconProfile:pluslogo,
            routes: [
        ...
        {
            text: 'Policies',
            expand: index==7?MinusIconProfile:pluslogo,
            routes: [
        ...
        <>
            <div className="">
                ...
                <div className="w-full mr-1 mt-2">
                    ...
                    {/* {patientData.id ? */}
                    <div className=" lg:bg-white-600 w-full  lg:p-3 lg:mb-2 lg:antialiased  " style={{ width: "304px", height: "821px", background: "white" }}>
                        ...
                        {(screen > 500 ? sideBardataWeb : location.calledFrom === "loginPerson" ? sideBardataWeb : sideBardata).map((res, i) => {
                                ...
                                <>
                                            ...
                                            <>
                                                ...
                                                <div onClick={(e) => {res.route ? redirectTo(e, res.route, false) : setIndex(i) }} style={{ color: "#262626" }} className={`${res.route === location.pathname ? " flex  font-normal text-sm items-center justify-between cursor-pointer leading-5 w-full py-2 px-2 rounded-md my-3" : 'flex w-full font-normal text-lg items-center justify-between cursor-pointer leading-5 px-2 py-2 my-3'}`}>
                                                    <div className='flex'>
                                                        ...
                                                        <img src={res.logo} alt="" className='h-6 ml-2 mr-3' style={{ color: "black" }} />
                                                        <p>{res.text}</p>
                                                    </div>
                                                    <div>
                                    ...
                                    {isOpen && index === i && < div x-show="dropdownOpen" className="ml-16 bg-hideblue cursor-pointer bg-white" style={{backgroundColor: "#FFFFFF"}}>
                                        {res?.routes?.map((data, j) => (
                                            <p style={{backgroundColor: "#FFFFFF"}} key={j} onClick={(e) => {redirectToSub(e, data.route, true) }} className={`${location.pathname === data.route ? 'bg-hideblue font-bold  text-gray-800 text-sm  my-2' : 'bg-hideblue text-gray-800 font-normal text-sm my-2'}`}>{data.text}</p>
                                        ))}
                                    </div>}
                            ...
                            <>
                                {
                                    ...
                                    <>
                                        ...
                                        <div className="flex cursor-pointer ml-5 content-center ">
