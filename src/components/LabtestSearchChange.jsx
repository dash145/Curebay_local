...
import tube from '../Assets/Images/locash.svg';
...
function LabtestSearchChange() {
    return (
      <>

    <div className="bg-gray-100 lg:py-12 lg:flex lg:justify-center">
    <p className="hidden text-xl pl-10 font-medium">Or Get the best price for the items in your cart</p>
      <p className="hidden text-xs text-gray-400 pl-10">Complete cart from one Labs</p>
            ...
            <div className="py-6 lg:w-11/12 pl-4">
                ...
                <p className="text-white text-sm pl-3">Reports ready in 36hrs </p>
                 ...
                 <div className="mt-2 flex space-x-3">
                     ...
                     <p className="text-sm  text-gray-400">No Special Preparation Required</p>
                 </div>
                 <div className="mt-2 flex space-x-3">
                     <img src={tube} alt="info" className="w-6"/>
                     <p className="text-sm  text-gray-400 pt-2">Lal Pathology + 2</p>
                 </div>
                 <div className="mt-2 flex space-x-3">
                 ...
                 <div className="mt-2 flex space-x-3">
                     ...
                     <p className="text-sm  text-gray-400 pt-2">Home Sample Collection Available</p>
                 </div>
        ...
        <div className="lg:mx-8 lg:flex ">
            ...
            <div className="py-6 lg:w-11/12 pl-4">
                <div className="flex justify-between">
                <p className="text-base text-gray-600 ">Vitamin D - Hydroxy
                </p>
                <div className="w-44 h-5 rounded-full bg-red-500">
                <p className="text-white text-sm pl-3">Reports ready in 36hrs </p>
                </div>
...
<div className="lg:mx-8 lg:flex ">
            ...
            <div className="py-6 lg:w-11/12 pl-4">
                <div className="flex justify-between">
                <p className="text-base text-gray-600 ">Vitamin D - Dihydroxy
                </p>
                <div className="w-44 h-5 rounded-full bg-red-500">
                <p className="text-white text-sm pl-3">Reports ready in 36hrs </p>
                </div>
...
export default LabtestSearchChange;