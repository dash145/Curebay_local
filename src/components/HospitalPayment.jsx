...
function HospitalPayment() {
  ...
  const redirectTo = (event) => {
    ...
    history.push(APP_ROUTES.HOSPITAL_APPONITMENTCONFIRMATION);
  };
  return (
    <>
      ...
      <div className="flex justify-between ">
        <div className="w-8/12 h-auto mt-4 ml-10  border border-gray-200">
          ...
          <button onClick={redirectTo} className="bg-brand-secondary mr-6 float-right text-white  py-2 px-4 rounded text-sm mt-4 ">Pay Now</button>
        </div>
        <div className="w-3/12 mr-6 mt-3">
          <div className="rounded-lg shadow-lg bg-white-600 w-full  p-3 antialiased border border-gray-200">
            ...
            <div className="flex">
              ...
              <div>
                <div className="flex justify-between">
                  <p className="text-sm pl-2 pt-2">Dr Pooja Pawar</p>
